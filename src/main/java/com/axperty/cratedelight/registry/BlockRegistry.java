...
public class BlockRegistry {
    ...
    public static final Block PUFFERFISH_CRATE = registerBlock("pufferfish_crate", Block::new, Block.Properties.ofFullCopy(Blocks.OAK_PLANKS));

    public static final Block TROPICAL_FISH_CRATE = registerBlock("tropical_fish_crate", Block::new, Block.Properties.ofFullCopy(Blocks.OAK_PLANKS));
