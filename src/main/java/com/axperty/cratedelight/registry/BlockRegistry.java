...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block> CARROT_CRATE = BLOCKS.register("carrot_crate",
            () -> new Block(Block.Properties.ofFullCopy(Blocks.OAK_PLANKS).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> GLOWBERRY_CRATE = BLOCKS.register("glowberry_crate",
            () -> new Block(Block.Properties.ofFullCopy(Blocks.OAK_PLANKS).sound(SoundType.WOOD).lightLevel((state) -> 13)));
