...
public class BlockRegistry {
    ...
    public static final Block PEANUT_CRATE = registerBlock("peanut_crate", new Block(AbstractBlock.Settings.copy(Blocks.OAK_PLANKS)));
    ...
    public static final Block SALT_BAG = registerBlock("salt_bag", new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL)));

    public static final Block GROUND_CINNAMON_BAG = registerBlock("ground_cinnamon_bag", new Block(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL)));
