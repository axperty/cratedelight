...
public class ModBlocks {
    ...
    public static final Block COCOABEANS_BAG = registerBlock("cocoabeans_bag",
            new Block(FabricBlockSettings.copy(Blocks.WHITE_WOOL).sounds(BlockSoundGroup.WOOL)), ModItemGroup.CREATIVE_MODE_TAB);
    ...
    public static final Block SALT_BAG = FabricLoader.getInstance().isModLoaded("expandeddelight") ?
            registerBlock("salt_bag", new Block(FabricBlockSettings.copy(Blocks.WHITE_WOOL).sounds(BlockSoundGroup.WOOL)), ModItemGroup.CREATIVE_MODE_TAB) : null;
    ...
    public static final Block GROUND_CINNAMON_BAG = FabricLoader.getInstance().isModLoaded("expandeddelight") ?
            registerBlock("ground_cinnamon_bag", new Block(FabricBlockSettings.copy(Blocks.WHITE_WOOL).sounds(BlockSoundGroup.WOOL)), ModItemGroup.CREATIVE_MODE_TAB) : null;

    // Wheat Flour Bag Registry (Create)
    public static final Block WHEAT_FLOUR_BAG = FabricLoader.getInstance().isModLoaded("create") ?
            registerBlock("wheat_flour_bag", new Block(FabricBlockSettings.copy(Blocks.WHITE_WOOL).sounds(BlockSoundGroup.WOOL)), ModItemGroup.CREATIVE_MODE_TAB) : null;

    // Powdered Bag Registry (Create)
    public static final Block POWDERED_OBSIDIAN_BAG = FabricLoader.getInstance().isModLoaded("create") ?
            registerBlock("powdered_obsidian_bag", new Block(FabricBlockSettings.copy(Blocks.WHITE_WOOL).sounds(BlockSoundGroup.WOOL)), ModItemGroup.CREATIVE_MODE_TAB) : null;
    ...
    public static final Block CINDER_FLOUR_BAG = FabricLoader.getInstance().isModLoaded("create") ?
            registerBlock("cinder_flour_bag", new Block(FabricBlockSettings.copy(Blocks.WHITE_WOOL).sounds(BlockSoundGroup.WOOL)), ModItemGroup.CREATIVE_MODE_TAB) : null;

    // Ender Dust Bag Registry (BetterEnd)
    public static final Block ENDER_DUST_BAG = FabricLoader.getInstance().isModLoaded("betterend") ?
            registerBlock("ender_dust_bag", new Block(FabricBlockSettings.copy(Blocks.WHITE_WOOL).sounds(BlockSoundGroup.WOOL)), ModItemGroup.CREATIVE_MODE_TAB) : null;
